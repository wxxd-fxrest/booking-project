                        ...
                        <Pressable style={{
                            ...
                            <Pressable>
                                <Text style={{
                                    ...
                                    fontSize: 18, 
                                    fontWeight: "500",
                                    paddingHorizontal: 6}}>{rooms}</Text>
                            </Pressable>
                        ...
                        <Pressable style={{
                            ...
                            <Pressable>
                                <Text style={{
                                    ...
                                    fontSize: 18, 
                                    fontWeight: "500",
                                    paddingHorizontal: 6}}>{adults}</Text>
                            </Pressable>
                        ...
                        <Pressable style={{
                            ...
                            <Pressable>
                                <Text style={{
                                    ...
                                    fontSize: 18, 
                                    fontWeight: "500",
                                    paddingHorizontal: 6}}>{children}</Text>
                            </Pressable>
